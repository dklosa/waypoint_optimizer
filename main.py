...
start = st.text_input("Start address.", key="start", value="Bismarckstr. 32 a, 28203 Bremen")
target = st.text_input("Target address.", key="target", value="küferstr. 17, 28779 bremen")
